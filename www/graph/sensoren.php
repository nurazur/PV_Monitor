<html><head><title>Azur de la mer Sensors</title>
...
<script type="text/javascript">
    ...
    function NeuerVerlauf(anz_tage)
    {
		...
		{		
			self.document.getElementById("verlauf").src = 'sunezy_today_plot.php?tag=' + cjour;
		...
		{		
			self.document.getElementById("temperatures").src = 'sunezy_today_temp.php?tag=' + cjour;
		...
		{		
			self.document.getElementById("voltages").src = 'bmp180_plot.php?tag=' + cjour;
		...
		{		
			self.document.getElementById("sensors").src = 'ds18b20_plot.php?tag=' + cjour;
    ...
    function energy_per_day ( plottype, tage, von, bis, monat, do_stretch, do_tagnacht)
	{
        ...
        var str_monat = "";
		var str_cmdline_17 = 'bmp180_plot.php?';
        var str_cmdline_27 = 'ds18b20_plot.php?';
...
$filename_last_log =  "../logfiles/last_log.txt";
...
<tr><td colspan =3 align =center ><h1>Azur de la mer Sensoren</h1></td></tr>
<tr>
...
&nbsp<br>
<input type="checkbox" name="plot1" value="leistung">Leistung<br>
<input type="checkbox" name="plot2" value="temperaturen" >Temperaturen&nbsp<br>
<input type="checkbox" name="plot4" value="temperaturen" checked="checked">Sensoren<br>
<input type="checkbox" name="plot3" value="temperaturen" checked="checked">Luftdruck<br><br>
&nbspDatum:&nbsp<br>
...
<tr id="sensor_zeile" style="visibility:visible"><td><img id="sensors" src = "./ds18b20_plot.php" style="visibility:visible"></img></td></tr>
<tr id="bmp180_zeile" style="visibility:visible"><td><img id="voltages" src = "./bmp180_plot.php" style="visibility:visible"></img></td></tr>
</table>
</td>
