...
function calc_logfilename($timestamp, $sensor = "bmp180")
{
    ...
    {
        errorlog("../debug_sunezy.txt", "logfile name is empty because it does not exist: ".$logfile."\n");
        $logfile ="";
    }
    else
    {
        errorlog("../debug_sunezy.txt", "logfile name: ".$logfile."\n");
    }    
